<template>
  <div
    class="team-area pt-100 pb-70"
    v-if="memberData.length > 0 || (isLoggedIn && userRole === 1)"
  >
    <div class="container">
      <div class="row">
        <div
            ...
            <div class="image position-relative text-center mb-3" style="margin: auto; display: block;">
              ...
              <ul class="social list-inline mt-2">
                <li class="list-inline-item">
                  <a href="https://www.facebook.com/profile.php?id=61576332803590" target="_blank"><i class="bx bxl-facebook"></i></a>
                </li>
                <li class="list-inline-item">
